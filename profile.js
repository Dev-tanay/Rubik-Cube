...
function handleCredentialResponse(response) {
  ...
  document.getElementById(
    "user-name"
  ).innerText = `Hello, ${responsePayload.name}`;
...
function loadUserProfile() {
  ...
  if (userProfile) {
    document.getElementById(
      "user-name"
    ).innerText = `Hello, ${userProfile.name}`;
...
function loadUserProgress() {
  ...
  if (userProgress) {
    document.querySelector('.stats[name="cube-size"] b').innerText =
      userProgress.cubeSize;
    document.querySelector('.stats[name="total-solves"] b').innerText =
      userProgress.totalSolves;
    document.querySelector('.stats[name="best-time"] b').innerText =
      userProgress.bestTime;
    document.querySelector('.stats[name="worst-time"] b').innerText =
      userProgress.worstTime;
    document.querySelector('.stats[name="average-5"] b').innerText =
      userProgress.average5;
    document.querySelector('.stats[name="average-12"] b').innerText =
      userProgress.average12;
    document.querySelector('.stats[name="average-25"] b').innerText =
      userProgress.average25;
  }
}
